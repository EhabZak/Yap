...
export const AutomotiveListings = () => {
  ...
  const listings = allListings.filter((listing)=> listing.category === "automotive")
//   console.log( "listings ============>>>>>>>>",   listings)
  ...
  return (
    <>
        ...
        <h2 className="category-heading">Best Automotive Places near You</h2>
