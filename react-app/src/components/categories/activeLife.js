...
export const ActiveLifeListings = () => {
  ...
  const listings = allListings.filter((listing)=> listing.category === "active life")
//   console.log( "listings ============>>>>>>>>",   listings)
  ...
  return (
    <>
        ...
        <h2 className="category-heading">Best Active Life Destination near You</h2>
