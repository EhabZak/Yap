...
export const SpaListings = () => {
  ...
  const listings = allListings.filter((listing)=> listing.category === "Spa")
//   console.log( "listings ============>>>>>>>>",   listings)
  ...
  return (
    <>
        ...
        <h2 className="category-heading">Best Beauty Places and Spas near You</h2>
