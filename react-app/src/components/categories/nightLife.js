...
export const NightLifeListings = () => {
  ...
  const listings = allListings.filter((listing)=> listing.category === "nightlife")
//   console.log( "listings ============>>>>>>>>",   listings)
  ...
  return (
    <>
        ...
        <h2 className="category-heading">Best NightLife Places near You</h2>
