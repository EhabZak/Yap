...
export const UpdateListing = ({ listing }) => {
  ...
  const [open_hours, setOpenHours] = useState(listing?.open_hours);
  const [close_hours, setCloseHours] = useState(listing?.close_hours);
...
//   const [isSubmitting, setIsSubmitting] = useState(false);
  ...
  useEffect(() => {
    // Pre-populate the form fields with listing data
    ...
    setCloseHours(listing.close_hours);
